...
public class RSATests: XCTestCase {
    ...
    public func testKey2048() throws {
        ...
        let verified = try RSA.SHA512.verify(ciphertext, signs: "vapor", key: rsaPublic)
        XCTAssertTrue(verified)
    }
...
let publicKeyString: CryptoData = """
-----BEGIN PUBLIC KEY-----
...
let privateKey2String: CryptoData = """
-----BEGIN RSA PRIVATE KEY-----
...
let publicKey2String: CryptoData = """
-----BEGIN PUBLIC KEY-----
...
let privateKey3String: CryptoData = """
-----BEGIN RSA PRIVATE KEY-----
...
let publicKey3String: CryptoData = """
-----BEGIN PUBLIC KEY-----
...
let privateKey4String: CryptoData = """
-----BEGIN RSA PRIVATE KEY-----
...
let publicKey4String: CryptoData = """
-----BEGIN PUBLIC KEY-----
...
let publicCertString: CryptoData = """
-----BEGIN CERTIFICATE-----
...
let privateCertString: CryptoData = """
-----BEGIN RSA PRIVATE KEY-----
